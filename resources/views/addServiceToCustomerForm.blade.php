...
@section('customerDetail')
  ...
  <br><br>  
    <div class="container col-sm-12">   
      <form class="form-horizontal" method="POST" action="{{route('editCustomer', [$customer->id ])}}">
         @csrf
        <div class="row">      
          <div class="col-sm-offset-1 col-sm-10">
            <h4 class="h2">Editar cliente</h4>
          </div>
        </div>
        <br><br>        
        <div class="row">      
          <div class="col-sm-offset-1 col-sm-5">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="postal_code">Código postal:</label>
              <div class="col-sm-10">          
                <input type="number" class="form-control" id="postal_code" name="postal_code" min="1" max="99999" value="{{$customer->postal_code}}">
              </div>
            </div>
          </div>
          ...
          <div class="c col-sm-5">
            ...
            <div class="form-group">
              <label class="control-label col-sm-3" for="observations">Obsevaciones:</label>
              <div class="col-sm-9">          
                <textarea class="form-control" rows="5" id="observations" name="observations">{{$customer->observations}}</textarea>
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-3" for="discharge_date">Fecha de alta:</label>
              <div class="col-sm-9">          
                <input type="date" class="form-control" id="discharge_date" name="discharge_date" value="{{$customer->discharge_date}}">
              </div>
              <br/><br/><br/>
              <div class="form-group">              
              <div class="col-sm-9">          
